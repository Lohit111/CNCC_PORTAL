...
class AdminAssignedPage extends ConsumerWidget {
  const AdminAssignedPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final cs = Theme.of(context).colorScheme;
    final state = ref.watch(adminProvider('assigned'));
    return state.when(
      ...
      data: (data) {
        ...
        return RefreshIndicator(
          onRefresh: () async =>
              ref.read(adminProvider('assigned').notifier).refresh(),
