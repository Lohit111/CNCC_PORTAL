...
class AdminHoldPage extends ConsumerWidget {
  const AdminHoldPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final cs = Theme.of(context).colorScheme;
    final state = ref.watch(adminProvider('hold'));
    return state.when(
